...
function editPlayer(id){
  ...
  var modal='<div id="edit-modal" style="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,.4);z-index:1000;display:flex;align-items:center;justify-content:center;" onkeydown="if(event.key===\'Enter\')event.preventDefault();">'
